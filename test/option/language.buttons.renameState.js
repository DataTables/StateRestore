describe('stateRestore - options - language.buttons.renameState', function () {
	let table;
	...
	describe('Functional tests', function () {
		...
		it('Change text', function () {
			...
			expect($('.dt-button-collection .dt-button:eq(1)').text()).toBe('unit test');
		});
	});
